#!~/.pyenv/versions/python-scripts/bin/python
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 30,2020
@author: Uday Billa
"""
...
def find_jobs_from(website, job_title, location, desired_characs, filename="results.xls"):    
    ...
    if website == 'Indeed':
        ...
        location_of_driver = '/usr/local/bin/'
...
find_jobs_from('Indeed', 'devops engineer', 'United States', desired_characs)